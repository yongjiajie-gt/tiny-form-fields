...
{-| JSON content from go\_choose\_multiple\_field\_fixture.json
-}
...
{-| JSON content from go\_choose\_one\_field\_fixture.json
-}
...
{-| JSON content from go\_long\_text\_fixture.json
-}
...
{-| JSON content from go\_optional\_field\_empty\_fixture.json
-}
...
{-| JSON content from go\_optional\_field\_filled\_fixture.json
-}
...
{-| JSON content from go\_presence\_fixture.json
-}
...
{-| JSON content from go\_short\_text\_field\_fixture.json
-}
...
{-| JSON content from go\_visibility\_rules\_hidewhen\_fixture.json
-}
...
{-| JSON content from go\_visibility\_rules\_showwhen\_fixture.json
-}
...
getTestCase name =
    case name of
        "choose_multiple_field_fixture" ->
            Just choose_multiple_field_fixtureJson

        "choose_one_field_fixture" ->
            Just choose_one_field_fixtureJson

        "dropdown_field_fixture" ->
            Just dropdown_field_fixtureJson

        "long_text_fixture" ->
            Just long_text_fixtureJson

        "optional_field_empty_fixture" ->
            Just optional_field_empty_fixtureJson

        "optional_field_filled_fixture" ->
            Just optional_field_filled_fixtureJson

        "presence_fixture" ->
            Just presence_fixtureJson

        "short_text_field_fixture" ->
            Just short_text_field_fixtureJson

        "visibility_rules_hidewhen_fixture" ->
            Just visibility_rules_hidewhen_fixtureJson

        "visibility_rules_showwhen_fixture" ->
            Just visibility_rules_showwhen_fixtureJson
