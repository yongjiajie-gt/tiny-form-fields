...
var $author$project$Main$choiceToString = function (choice) {
	return _Utils_eq(
		...
		$elm$core$String$trim(choice.i)) ? choice.c : _Utils_ap(
		choice.i,
	...
	if (!_v0.$) {
		...
		if (!_v1.$) {
			...
			return $elm$core$String$isEmpty(
				$elm$core$String$trim(formField.c)) || A3($author$project$Main$hasDuplicateLabel, prevIndex, formField.c, model.f);
		} else {
			return false;
		}
	} else {
				...
				if ($elm$core$String$isEmpty(
					...
					if (A2(
						...
						if (_v1.$ === 4) {
							...
							if (((!filter.$) && (filter.a.$ === 2)) && (filter.a.a === '')) {
								return $elm$core$Maybe$Just('\"' + (f.c + '\": filter prefix cannot be empty'));
							} else {
								return $elm$core$Maybe$Nothing;
							}
						}
						...
						return $elm$core$String$isEmpty(filterValue) ? _List_Nil : A2(
							...
							function (choice) {
								return A2(
									...
									$elm$core$String$toLower(choice.i)) || A2(
									$elm$core$String$startsWith,
									$elm$core$String$toLower(filterValue),
									...
									A2(
										...
										function (choice) {
											return A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$value(choice.i)
													]),
												_List_fromArray(
													[
										...
										return A2(
											...
											A2(
												...
												A2(
													$elm$core$List$cons,
													$author$project$Main$defaultSelected(
														_Utils_eq(valueString, choice.i) || chosenForYou(filteredChoices)),
													config._)),
											_List_fromArray(
												[
													$elm$html$Html$text(choice.c)
							...
							[
								...
								A2(
									...
									function (choice) {
										...
										var shouldDisable = alreadyFull && (!A2($elm$core$List$member, choice.i, values));
										return A2(
											$elm$html$Html$div,
											_List_fromArray(
												[
															...
															_Utils_ap(
																_List_fromArray(
																	[
																		...
																		$elm$html$Html$Attributes$value(choice.i),
																		$elm$html$Html$Attributes$checked(
																		A2($elm$core$List$member, choice.i, values) || chosenForYou(filteredChoices)),
																		A2($elm$html$Html$Attributes$attribute, 'aria-describedby', fieldID + '-description')
																	]),
																_Utils_ap(
		...
		return A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$core$Maybe$Just(
						$elm$html$Html$Attributes$value(opt.i)),
										...
										A2(
											...
											function (c) {
												return A2(
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$value(c.i)
														]),
													_List_Nil);
											},
											choices)));
						...
						[
							...
							var optionRecord = F4(
								function (value, label, selected, disabled) {
									return {bO: disabled, c: label, bl: selected, i: value};
								});
			...
			function (fieldName, choice) {
				return _List_fromArray(
					[
						$elm$html$Html$Events$onCheck(
						function (_v5) {
							return A2($author$project$Main$OnFormValuesUpdated, fieldName, choice.i);
						})
					]);
			});
