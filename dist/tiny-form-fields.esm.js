...
{
	if (region.bo.aN === region.bQ.aN)
	{
		return 'on line ' + region.bo.aN;
	}
	return 'on lines ' + region.bo.aN + ' through ' + region.bQ.aN;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ds: 'hidden', de: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ds: 'mozHidden', de: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ds: 'msHidden', de: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ds: 'webkitHidden', de: 'webkitvisibilitychange' }
		: { ds: 'hidden', de: 'visibilitychange' };
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{z: nodeList, u: (len / $elm$core$Array$branchFactor) | 0, y: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {b_: fragment, b4: host, A: path, cz: port_, cF: protocol, cG: query};
	});
	...
	if (_v0.b) {
		if (!_v0.b.b) {
			...
			if (!_v0.b.b.b) {
				...
				var labels = _v0.b;
				return {
					c: A2($elm$core$String$join, $author$project$Main$choiceDelimiter, labels),
					j: $elm$core$String$trim(value)
				};
			}
		}
...
var $author$project$Main$fromRawCustomElement = function (ele) {
	return {
		q: A2(
			...
			ele.q),
		ag: function () {
			var _v1 = A2($elm$core$Dict$get, 'list', ele.q);
			if (!_v1.$) {
				var s = _v1.a;
				var _v2 = A2(
		...
		aj: function () {
			var _v4 = A2($elm$core$Dict$get, 'maxlength', ele.q);
			if (!_v4.$) {
				if (_v4.a === '') {
					return $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing);
				} else {
		...
		as: function () {
			var _v6 = A2($elm$core$Dict$get, 'min', ele.q);
			if (!_v6.$) {
				if (_v6.a === '') {
					return $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing);
				} else {
		...
		aO: function () {
			var _v7 = A2($elm$core$Dict$get, 'multiple', ele.q);
			if (!_v7.$) {
				switch (_v7.a) {
					case '':
						return $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing);
...
var $author$project$Main$FormField = F6(
	function (label, name, presence, description, type_, visibilityRule) {
		return {U: description, c: label, S: name, p: presence, a: type_, m: visibilityRule};
	});
		...
		while (true) {
			...
			if (_Utils_cmp(
				...
				return A2(
					$elm$core$Array$builderToArray,
					true,
					{z: nodeList, u: nodeListSize, y: jsArray});
			} else {
...
var $author$project$Main$choiceToString = function (choice) {
	return _Utils_eq(
		$elm$core$String$trim(choice.c),
		$elm$core$String$trim(choice.j)) ? choice.c : _Utils_ap(
		choice.j,
		_Utils_ap($author$project$Main$choiceDelimiter, choice.c));
};
...
var $author$project$Main$encodePairsFromRawCustomElements = function (customElement) {
	...
	return A2(
		...
		_Utils_Tuple2(
			'inputType',
			$elm$json$Json$Encode$string(customElement.D)),
					...
					A2(
						...
						_List_fromArray(
							[
								_Utils_Tuple2(
								'label',
								$elm$json$Json$Encode$string(formField.c)),
								_Utils_Tuple2(
								'name',
								function () {
									var _v0 = formField.S;
								...
								_Utils_Tuple2(
								'presence',
								$author$project$Main$encodePresence(formField.p)),
								_Utils_Tuple2(
								'description',
								A2($author$project$Main$encodeAttributeOptional, $elm$json$Json$Encode$string, formField.U)),
								_Utils_Tuple2(
								'type',
...
var $author$project$Main$fieldNameOf = function (formField) {
	return A2($elm$core$Maybe$withDefault, formField.c, formField.S);
};
...
var $author$project$Main$init = function (flags) {
	...
	if (!_v0.$) {
						...
						if (_v1.$ === 4) {
							...
							return A2(
								...
								A2(
									...
									A3($author$project$Main$maybeDecode, fieldName, $elm$json$Json$Decode$string, config.ba)));
						}
					}();
		...
		var allCustomElements = $author$project$Main$allCustomElementsFromGroups(config.V);
		return _Utils_Tuple2(
			{
				az: 0,
				...
				ac: !$elm$core$Array$isEmpty(
					A2(
						...
						config.f)),
				ad: $elm$core$Array$length(config.f) + 1,
				s: $elm$core$Maybe$Nothing,
				am: $elm$core$Dict$fromList(
					A2(
						$elm$core$List$map,
						function (customElement) {
							return _Utils_Tuple2(customElement.D, customElement);
						},
						allCustomElements)),
				...
				_List_fromArray(
					[
						...
						$author$project$Main$encodePortOutgoingValue(
							$author$project$Main$PortOutgoingFormFields(config.f)))
					])));
	} else {
		var err = _v0.a;
		return _Utils_Tuple2(
		...
		var helper = F2(
			function (node, builder) {
				if (!node.$) {
					...
					var leaf = node.a;
					var offset = builder.u * $elm$core$Array$branchFactor;
					...
					if (!dropIndex.$) {
						...
						if (_Utils_eq(dragIndex, index) || (!_Utils_eq(index, dropTargetIndex))) {
							...
							var newFormFields = $elm$core$Array$fromList(
								function (list) {
									var draggedField = A2($elm$core$Array$get, dragIndex, model.f);
							...
							return _Utils_update(
								model,
								{r: $elm$core$Maybe$Nothing, f: newFormFields});
						}
					} else {
						return _Utils_update(
							model,
				...
				if (targetIndex.$ === 1) {
					...
					if (!dropIndex.$) {
						...
						if (!_Utils_eq(index, dropTargetIndex)) {
							...
							return _Utils_update(
								model,
								{r: $elm$core$Maybe$Nothing, f: newFormFields, ad: model.ad + 1});
						}
					} else {
						return _Utils_update(
							model,
...
var $author$project$Main$fieldHasEmptyPrefix = function (formField) {
	var _v0 = formField.a;
	switch (_v0.$) {
		case 2:
			var filter = _v0.a.d;
...
var $author$project$Main$selectedFieldIsInvalid = function (model) {
	...
	if (!_v0.$) {
		var prevIndex = _v0.a;
		var _v1 = A2($elm$core$Array$get, prevIndex, model.f);
		if (!_v1.$) {
			var formField = _v1.a;
			return $elm$core$String$isEmpty(
				$elm$core$String$trim(formField.c)) || (A3($author$project$Main$hasDuplicateLabel, prevIndex, formField.c, model.f) || $author$project$Main$fieldHasEmptyPrefix(formField));
		} else {
			return false;
		}
	} else {
		...
		if (!maybeFilter.$) {
			switch (maybeFilter.a.$) {
						...
						return $elm$core$String$isEmpty(filterValue) ? _List_Nil : A2(
							...
							function (choice) {
								return A2(
									...
									$elm$core$String$startsWith,
									$elm$core$String$toLower(filterValue),
									$elm$core$String$toLower(choice.c));
							},
							choices);
					} else {
						return _List_Nil;
				...
				default:
					...
					if ($elm$core$String$isEmpty(prefix)) {
						return choices;
					} else {
						var loweredPrefix = $elm$core$String$toLower(prefix);
						return A2(
							$elm$core$List$filter,
							function (choice) {
								return A2(
...
var $author$project$Main$effectiveChoiceCount = F2(
	function (filter, choices) {
		if ((!filter.$) && (filter.a.$ === 2)) {
			return $elm$core$List$length(
				A3($author$project$Main$filterChoices, filter, $elm$core$Dict$empty, choices));
		} else {
			return $elm$core$List$length(choices);
		}
	});
		...
		switch (msg.$) {
			...
			case 1:
				return (string === '') ? _Utils_update(
					formField,
					{
						U: $author$project$Main$AttributeInvalid('')
					}) : _Utils_update(
					formField,
					{
						U: $author$project$Main$AttributeGiven(string)
					});
			case 2:
				var bool = msg.a;
				return _Utils_update(
					formField,
					{
						U: A2($author$project$Main$toggleAttributeOptional, bool, formField.U)
					});
			case 3:
				var bool = msg.a;
				...
				if (_v1.$ === 4) {
					...
					var finalMinRequired = function () {
						if (!adjustedMinRequired.$) {
							...
							return (_Utils_cmp(min, choiceCap) > 0) ? $elm$core$Maybe$Just(choiceCap) : $elm$core$Maybe$Just(min);
						} else {
							return $elm$core$Maybe$Nothing;
						}
					}();
				...
				if (_v4.$ === 4) {
					...
					var finalMaxAllowed = function () {
						if (!adjustedMaxAllowed.$) {
							...
							return (_Utils_cmp(max, maxChoiceCap) > 0) ? $elm$core$Maybe$Just(maxChoiceCap) : $elm$core$Maybe$Just(max);
						} else {
							return $elm$core$Maybe$Nothing;
						}
					}();
			...
			case 20:
				...
				if (!_v7.$) {
					...
					var newCustomElement = _Utils_update(
						customElement,
						{
							as: $elm$core$String$isEmpty(minStr) ? $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing) : $author$project$Main$AttributeGiven(minStr)
						});
					return _Utils_update(
						formField,
						{
			...
			case 21:
				...
				if (!_v8.$) {
					...
					var newCustomElement = _Utils_update(
						customElement,
						{
							ar: $elm$core$String$isEmpty(maxStr) ? $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing) : $author$project$Main$AttributeGiven(maxStr)
						});
					return _Utils_update(
						formField,
						{
				...
				switch (_v12.$) {
					case 0:
						...
						var newCustomElement = _Utils_update(
							customElement,
							{
								aO: $author$project$Main$AttributeGiven(bool)
							});
						return _Utils_update(
							formField,
							{
				...
				switch (_v13.$) {
					case 0:
						...
						var newCustomElement = _Utils_update(
							customElement,
							{
								aj: A2($author$project$Main$toggleAttributeOptional, bool, customElement.aj)
							});
						return _Utils_update(
							formField,
							{
			...
			case 18:
				...
				if (!_v17.$) {
					...
					var newCustomElement = _Utils_update(
						customElement,
						{
							as: A2($author$project$Main$toggleAttributeOptional, bool, customElement.as)
						});
					return _Utils_update(
						formField,
						{
				...
				switch (_v19.$) {
					case 0:
						...
						var newCustomElement = _Utils_update(
							customElement,
							{
								ag: A2($author$project$Main$toggleAttributeOptional, bool, customElement.ag)
							});
						return _Utils_update(
							formField,
							{
							...
							formField,
							{
								a: $author$project$Main$Dropdown(
									_Utils_update(
										settings,
										{
											d: updateSourceField(settings.d)
										}))
							});
					case 3:
						var settings = _v31.a;
			...
			default:
				...
				var updatePrefix = function (existingFilter) {
					if ((!existingFilter.$) && (existingFilter.a.$ === 2)) {
						return $elm$core$Maybe$Just(
...
var $author$project$Main$when = F2(
	function (bool, condition) {
		return bool ? condition.a4 : condition.aX;
	});
		...
		while (true) {
			switch (msg.$) {
				...
				case 2:
					var fieldType = msg.a;
					var newFormField = {
						U: $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing),
						c: $author$project$Main$stringFromInputField(fieldType) + (' question ' + $elm$core$String$fromInt(model.ad)),
						S: $elm$core$Maybe$Nothing,
						p: A2(
					...
					var newFormFields = $elm$core$Array$fromList(
						A2(
							...
							A2(
								...
								$elm$core$Array$toIndexedList(model.f))));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{f: newFormFields, s: $elm$core$Maybe$Nothing}),
						$author$project$Main$outgoing(
							$author$project$Main$encodePortOutgoingValue(
								$author$project$Main$PortOutgoingFormFields(newFormFields))));
				case 4:
					var fieldIndex = msg.a;
					var newFormFields = A3($author$project$Main$swapArrayIndex, fieldIndex, fieldIndex - 1, model.f);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								f: newFormFields,
								s: $elm$core$Maybe$Just(fieldIndex - 1)
							}),
						$author$project$Main$outgoing(
							$author$project$Main$encodePortOutgoingValue(
								$author$project$Main$PortOutgoingFormFields(newFormFields))));
					...
					var newFormFields = A2(
						...
						F2(
							function (i, formField) {
								return _Utils_eq(i, fieldIndex) ? A5($author$project$Main$updateFormField, fmsg, fieldIndex, string, model.f, formField) : formField;
							}),
						model.f);
					return _Utils_Tuple2(
						_Utils_update(
				...
				case 8:
					var fieldIndex = msg.a;
					var _v4 = _Utils_Tuple2(model.s, fieldIndex);
					if (!_v4.a.$) {
						...
						if ($author$project$Main$selectedFieldIsInvalid(model)) {
							...
							var _v5 = _Utils_Tuple2(model.s, fieldIndex);
							if ((!_v5.a.$) && (_v5.b.$ === 1)) {
								...
								model,
								{
									r: $elm$core$Maybe$Just(
										$author$project$Main$DragExisting(
											{a9: fieldIndex, G: $elm$core$Maybe$Nothing})),
									s: $elm$core$Maybe$Nothing
								}),
							$elm$core$Platform$Cmd$none);
					}
				...
				case 13:
					...
					return _Utils_Tuple2(
						newModel,
						(!_Utils_eq(newModel.f, model.f)) ? $author$project$Main$outgoing(
							$author$project$Main$encodePortOutgoingValue(
								$author$project$Main$PortOutgoingFormFields(newModel.f))) : $elm$core$Platform$Cmd$none);
				case 14:
					if (!msg.b.b) {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
		...
		A2(
			...
			function (_v0) {
				...
				if ($elm$core$String$isEmpty(
					$elm$core$String$trim(f.c))) {
					return $elm$core$Maybe$Just('Question title cannot be empty');
				} else {
					if (A2(
						$elm$core$Maybe$withDefault,
						0,
						A2($elm$core$Dict$get, f.c, labelCounts)) > 1) {
						return $elm$core$Maybe$Just('Duplicate question title: \"' + (f.c + '\"'));
					} else {
						var _v1 = f.a;
						if (_v1.$ === 4) {
							var choices = _v1.a.k;
							...
							return $author$project$Main$fieldHasEmptyPrefix(f) ? $elm$core$Maybe$Just('\"' + (f.c + '\": filter prefix cannot be empty')) : (A2(
								...
								A2(
									...
									minRequired)) ? $elm$core$Maybe$Just('\"' + (f.c + '\": minimum required exceeds number of choices')) : (A2(
								$elm$core$Maybe$withDefault,
								false,
								A2(
									$elm$core$Maybe$map,
									...
									maxAllowed)) ? $elm$core$Maybe$Just('\"' + (f.c + '\": maximum allowed exceeds number of choices')) : (A2(
								$elm$core$Maybe$withDefault,
								false,
								A3(
									$elm$core$Maybe$map2,
									...
									minRequired,
									maxAllowed)) ? $elm$core$Maybe$Just('\"' + (f.c + '\": minimum required exceeds maximum allowed')) : $elm$core$Maybe$Nothing)));
						} else {
							return $author$project$Main$fieldHasEmptyPrefix(f) ? $elm$core$Maybe$Just('\"' + (f.c + '\": filter prefix cannot be empty')) : $elm$core$Maybe$Nothing;
						}
					}
				}
			},
...
var $author$project$Main$isFieldReferencedBy = F2(
	function (fieldName, formFields) {
		...
		var isUsedInVisibilityRules = A2(
			...
			fieldList);
		return {a6: isUsedInChoiceFilters, a7: isUsedInVisibilityRules};
	});
...
var $author$project$Main$isOptionalTemporalInput = function (formField) {
	var _v0 = _Utils_Tuple2(formField.p, formField.a);
	if ((_v0.a === 1) && (!_v0.b.$)) {
		var _v1 = _v0.a;
		...
		var inputType = A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Dict$get, 'type', customElement.q));
		return A2(
			$elm$core$List$member,
			inputType,
			_List_fromArray(
	...
	function (config, fieldID, formField) {
		...
		switch (_v0.$) {
						...
						$elm$core$Dict$toList(
							A2(
								...
								A2(
									...
									A2($elm$core$Dict$get, customElement.D, config.am))))));
				var _v1 = function () {
					var _v2 = customElement.ag;
					switch (_v2.$) {
						case 2:
							var list = _v2.a;
							return _Utils_Tuple2(
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										'class',
										A3($author$project$Main$buildInputClassString, formField, fieldName, config.w)),
			...
			case 2:
				...
				return (noChoicesAfterFiltering && config.ac) ? A2($elm$html$Html$div, _List_Nil, _List_Nil) : A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
			...
			default:
				...
				var validationElement = function () {
					var effectiveMin = function () {
						var _v10 = _Utils_Tuple2(formField.p, minRequired);
						if ((_v10.a === 2) && (_v10.b.$ === 1)) {
							var _v11 = _v10.a;
							var _v12 = _v10.b;
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(formField.c),
									function () {
									var _v0 = formField.p;
									switch (_v0) {
										case 0:
							...
							[
								...
								_List_fromArray(
									[
										...
										var fieldName = $author$project$Main$fieldNameOf(formField);
										var referencedInfo = A2($author$project$Main$isFieldReferencedBy, fieldName, model.f);
										return A2(
											$elm$html$Html$div,
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													(hasVisibilityRules || referencedInfo.a7) ? A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class(
															...
															(hasVisibilityRules && referencedInfo.a7) ? 'This field has visibility logic and other fields\' visibility depends on it' : (hasVisibilityRules ? 'This field has visibility logic' : 'Other fields\' visibility depends on this field\'s value'))
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(
															(hasVisibilityRules && referencedInfo.a7) ? 'Contains & affects logic' : (hasVisibilityRules ? 'Contains logic' : 'Affects logic'))
														])) : $elm$html$Html$text(''),
													(hasFilterChoices || referencedInfo.a6) ? A2(
													$elm$html$Html$div,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class(
															...
															$elm$html$Html$Attributes$title(
															(hasFilterChoices && referencedInfo.a6) ? 'This field filters choices and other fields\' choices depend on it' : (hasFilterChoices ? 'This field filters choices based on another field' : 'Other fields\' choices depend on this field\'s value'))
														]),
													_List_fromArray(
														[
															$elm$html$Html$text(
															(hasFilterChoices && referencedInfo.a6) ? 'Filters & affects choices' : (hasFilterChoices ? 'Filters choices' : 'Affects choices'))
														])) : $elm$html$Html$text('')
												]));
									}(),
										A3(
							...
							[
								...
								$elm$json$Json$Decode$succeed(
									$author$project$Main$DragStartNew(
										{
											U: $author$project$Main$AttributeNotNeeded($elm$core$Maybe$Nothing),
											c: $author$project$Main$stringFromInputField(inputField) + (' question ' + $elm$core$String$fromInt(nextQuestionNumber)),
											S: $elm$core$Maybe$Nothing,
											p: A2(
												$author$project$Main$when,
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Events$onCheck(options.ae)
										]),
									_List_Nil),
									$elm$html$Html$text(' '),
									$elm$html$Html$text(options.c)
								]))
						]));
			case 1:
											...
											[
												...
												A2(
													...
													A2(
														$elm$core$List$map,
														function (field) {
															var fieldValue = A2($elm$core$Maybe$withDefault, field.c, field.S);
																...
																_List_fromArray(
																	[
																		...
																		'value of ' + A2(
																			...
																			0,
																			$elm$json$Json$Encode$string(field.c)))
																	]));
														},
														otherFields)))
											]))
						...
						A2(
							...
							$elm$core$List$head(
								A2(
									...
									function (_v6) {
										var inputType = _v6.D;
										return _Utils_eq(inputType, customElement.D);
									},
									shortTextTypeList)))));
				return _Utils_ap(
					_List_fromArray(
					...
					((customElement.D === 'date') || (A2(
						$elm$core$Maybe$withDefault,
						'',
						A2($elm$core$Dict$get, 'type', customElement.q)) === 'date')) ? _List_fromArray(
						[
							A2(
							$author$project$Main$inputAttributeOptional,
							{
...
var $author$project$Main$selectInputGroup = function (_v0) {
	var selectAttrs = _v0.cQ;
	var options = _v0.cv;
	var inputNode = _v0.b8;
						...
						[
							...
							var optionRecord = F4(
								function (value, label, selected, disabled) {
									return {bO: disabled, c: label, bl: selected, j: value};
								});
							...
							var candidateFieldsExceptSelf = A2(
								$elm$core$List$filter,
								function (f) {
									var fn = A2($elm$core$Maybe$withDefault, f.c, f.S);
														...
														_List_fromArray(
															[
																...
																'value of ' + A2(
																	$elm$json$Json$Encode$encode,
																	0,
																	$elm$json$Json$Encode$string(f.c)))
															]));
												},
												otherFields))),
										$author$project$Main$selectArrowDown
...
var $author$project$Main$viewFormFieldBuilder = F5(
	function (shortTextTypeList, index, totalLength, formFields, formField) {
		var isEmptyLabel = $elm$core$String$isEmpty(
			$elm$core$String$trim(formField.c));
		var isDuplicateLabel = A3($author$project$Main$hasDuplicateLabel, index, formField.c, formFields);
								...
								_Utils_ap(
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$value(formField.c),
											$elm$html$Html$Attributes$required(true),
											$elm$html$Html$Events$onInput(
...
var $author$project$Main$viewRightPanel = function (modelData) {
	var rightPanelClasses = A2(
		...
		A2(
			$elm$core$List$cons,
			'tff-right-panel',
			(!_Utils_eq(modelData.s, $elm$core$Maybe$Nothing)) ? _List_fromArray(
						...
						if (!_v0.$) {
							...
							if (!_v1.$) {
								...
								return A5(
									...
									$author$project$Main$allCustomElementsFromGroups(modelData.V),
									index,
	...
	function (maybeAnimate, model) {
		...
		var activeFields = A2(
			...
			A2(
				...
				$elm$core$List$head(
					A2($elm$core$List$drop, model.az, model.V))));
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							...
							_Utils_ap(
								($elm$core$List$length(model.V) > 1) ? _List_fromArray(
									[
										A2($author$project$Main$viewFieldGroupTabs, model.az, model.V)
									]) : _List_Nil,
								_List_fromArray(
									[
										A2($author$project$Main$viewAddQuestionsList, model.ad, activeFields)
									])))),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
...
var $author$project$Main$viewFormPreview = F2(
	function (customAttrs, _v0) {
		...
		var needsFormLogic = _v0.ac;
		var trackedFormValues = _v0.w;
		var shortTextTypeDict = _v0.am;
		...
		var config = {
			...
			f: formFields,
			ac: needsFormLogic,
			bi: needsEventHandlers ? onChangeAttrs : function (_v1) {
				return _List_Nil;
			},
			bj: needsEventHandlers ? onChooseManyAttrs : F2(
				function (_v2, _v3) {
					return _List_Nil;
				}),
			aQ: needsEventHandlers ? onInputAttrs : function (_v4) {
				return _List_Nil;
			},
			am: shortTextTypeDict,
			w: trackedFormValues
		};
		...
		function () {
			...
			if (!_v0.$) {
				...
				return A2(
					...
					A2(
						$elm$core$List$cons,
						$author$project$Main$viewEditorValidationGate(model.f),
						A2($author$project$Main$viewFormBuilder, editorAttr.aa, model)));
			} else {
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{dv: $author$project$Main$init, dV: $author$project$Main$subscriptions, dY: $author$project$Main$update, dZ: $author$project$Main$view});
/*
